...
GSAP and its plugins (ScrollTrigger, ScrollTo, MotionPath) are now loaded from the CDN, new interface, major code improvements, Elementor 3.6 friendly, many more...
...
1.9.0 - Beware of the changes to the language file!
